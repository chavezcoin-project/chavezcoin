...
#ifdef _WIN32
const std::string chavezcoinDaemon = "chavezcoind.exe";
#else
const std::string chavezcoinDaemon = "chavezcoind";
#endif
...
TestNodeConfiguration TestNetworkBuilder::buildNodeConfiguration(size_t index) {
  ...
  cfg.daemonPath = chavezcoinDaemon; // default
  cfg.testnet = testnet;
  cfg.logFile = "test_chavezcoind" + std::to_string(index) + ".log";
