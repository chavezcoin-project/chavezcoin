...
const command_line::arg_descriptor<uint16_t> arg_daemon_port = { "daemon-port", "Use daemon instance at port <arg> instead of 47048", 0 };
...
void simple_wallet::handle_command_line(const boost::program_options::variables_map& vm) {
  ...
  m_default_fee = CryptoNote::parameters::DEFAULT_FEE;
...
int main(int argc, char* argv[]) {
  ...
  bool r = command_line::handle_error_helper(desc_all, [&]() {
    ...
    if (command_line::get_arg(vm, command_line::arg_help)) {
      ...
      CryptoNote::Currency tmp_currency = currencyBuilder.currency();
